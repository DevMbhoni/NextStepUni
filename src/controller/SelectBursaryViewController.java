...
public class SelectBursaryViewController extends BaseController implements Initializable {
    @FXML
    ...
    private void handleSelect(Bursary bursary) {
        SceneManager.switchTo("/view/view_bursary_review.fxml",
                (ViewBursaryReviewController controller) -> controller.initData(bursary));
    }
